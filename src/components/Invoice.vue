<template>
  ...
  >
    <div class="left flex">
      ...
      <span class="due-data">{{ invoice.paymentDueData }}</span>
    ...
    <div class="right flex">
      ...
      >
        <span v-if="invoice.invoicePaid">Оплачен</span>
        <span v-if="invoice.invoiceDraft">Черновик</span>
        <span v-if="invoice.invoicePending">Не оплачен</span>
      </div>
      <div class="icon">
